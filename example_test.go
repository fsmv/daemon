...
// A basic example of a go client for portal with encrypted internal traffic.
//
// Simply change the handlers to any application logic you like using the
// standard [net/http] package.
//
// Don't forget to build with CGO_ENABLED=0 set so it works in a chroot!
func Example() {
	flag.Parse()
